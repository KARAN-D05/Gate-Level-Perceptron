...
- If not satisfied by the system output - press the Error_In and it will automatically start a correction sequence and system will autonomously start altering its decision boundary to flip its output.
