...
- This project constructs a self-learning pattern recognition engine using discrete logic gates. Evolving from strict boolean matching to score-based decision-making to feedback-driven adaptive learning and further to eventually a Hardware perceptron.
