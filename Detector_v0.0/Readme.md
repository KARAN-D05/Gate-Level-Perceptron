...
## 🔮Next Version 
- Reverses the Mathematical behaviour of current version for recognition (A<sub>rc</sub> &subseteq; W<sub>rc</sub>) to A<sub>rc</sub> ⊇ W<sub>rc</sub>.
- Recognizes Equivalence and Super-Patterns.
- [Check this out](https://github.com/KARAN-D05/Gate-Level-Perceptron/Detector_v0.1)
