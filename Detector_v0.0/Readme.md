...
- I tried to make a self-learning unit inspired by Rosenblatt’s perceptron, but since my weights were binary instead of analog, it basically became a pixel filter 😂.
